<template>
  <div class="recommend-wrapper">
            ...
            <div class="post-card">
              <a @click="detailPage(recommend.postId)">
                ...
                <div class="contents">
                  ...
                  <div
                    class="tag"
                    v-for="(tag, index) in recommend.hashtag.split(',')"
                    :key="`hash_${index}`"
                  >
    ...
    <button
      v-if="lowLike"
      class="select_button"
      @click.prevent="handLike();"
      style="margin-right:2px;"
    >좋아요 피드백 적용 완료!</button>
    <br />
...
export default {
  ...
  methods: {
    ...
    initMap() {
      ...
      var address_name = this.recommendList[Object.keys(this.recommendList)[0]]
        .address;
    ...
    recommendToMe() {
      ...
      if (this.lowStar || this.lowLike || this.lowWatch) {
        axios
          .post(`${this.SERVER_URL}/articles/getRecommentList/`, {
    ...
    initTmap() {
      ...
      var querystring = Object.entries(this.mapdata)
        .map((e) => e.join("="))
        .join("&");
        ...
        .then((res) => {
          ...
          for (var k in resultData) {
            ...
            if (geometry.type == "LineString") {
              ...
              var convertPoint2 = new Tmapv2.Projection.convertEPSG3857ToWGS84GEO(
                latlon
              );
    ...
    select() {
      if (
        Object.keys(this.recommendList).length == 2 &&
        this.recommendList[Object.keys(this.recommendList)[0]].lon &&
        this.recommendList[Object.keys(this.recommendList)[0]].lat &&
        this.recommendList[Object.keys(this.recommendList)[1]].lon &&
        this.recommendList[Object.keys(this.recommendList)[1]].lat
      ) {
        this.mapdata.startX = this.recommendList[
          Object.keys(this.recommendList)[0]
        ].lon;
        this.mapdata.startY = this.recommendList[
          Object.keys(this.recommendList)[0]
        ].lat;
        this.mapdata.endX = this.recommendList[
          Object.keys(this.recommendList)[1]
        ].lon;
        this.mapdata.endY = this.recommendList[
          Object.keys(this.recommendList)[1]
        ].lat;
        ...
        this.mapdata.passList =
          ...
          this.recommendList[Object.keys(this.recommendList)[1]].lat;
        this.mapdata.endX = this.recommendList[
          Object.keys(this.recommendList)[2]
        ].lon;
        this.mapdata.endY = this.recommendList[
          Object.keys(this.recommendList)[2]
        ].lat;
